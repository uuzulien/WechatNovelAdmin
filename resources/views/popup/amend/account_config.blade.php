    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="exampleModalLabel">修改账号</h4>
            </div>
            <form class="form-horizontal" method="post" action="{{route('account.config.amend')}}">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-2">平台名称:</label>
                        <div class="col-xs-12 col-sm-8">
                            <input class="form-control" id="pfname" name="pfname" type="text">
